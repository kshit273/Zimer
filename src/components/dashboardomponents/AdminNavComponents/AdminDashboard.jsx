...
const AdminDashboard = () => {
  ...
  return (
    <div className='p-5 flex flex-col gap-5 bg-[#e2e2e2] w-full h-[100vh]'>
      <div>
      ...
      <div className="bg-[#d9d9d9] w-full h-auto rounded-[20px] p-5">
        <div className="flex items-center mb-5">
          <p className="font-medium text-[30px] text-[#1a1a1a]">Admin dashboard</p>
        </div>
        <div className="flex gap-5">
          <div className="w-[75%] h-auto bg-[#e2e2e2] rounded-[20px]">
            <PGList managedPGs={['','','','','']}/>
          </div>
