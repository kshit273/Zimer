...
const PgReview = ({ RID, pgData }) => {
  ...
  return (
    <div className="w-full flex flex-col items-center pt-[100px]">
      <div className="head">
        <p className="text-[28px] font-medium mb-[30px]">
          What others say about this place
        </p>
      </div>
      <div className="pict flex gap-[30px] items-center">
        <div className="finRating flex flex-col items-center justify-center gap-[10px] ">
          <p className="text-[16px] text-[#464646] ">Overall rating</p>
          <div className="text-[#464646] text-[36px] font-medium">
            {overallRating}
          </div>
        ...
        <div className="env flex flex-col items-center justify-center gap-[10px]">
          <p className="text-[16px] text-[#464646]">Community and environment</p>
          <img src="/images/group.png" alt="" className="h-[40px] w-[40px]" />
          <div className="text-[#464646] text-[16px] font-medium">
            {communityRating}
          </div>
        </div>
        ...
        <div className="val flex flex-col items-center justify-center gap-[10px]">
          <p className="text-[16px] text-[#464646]">Value for money</p>
          <img src="/images/bar-chart.png" alt="" className="h-[40px] w-[40px]" />
          <div className="text-[#464646] text-[16px] font-medium">
            {valueRating}
          </div>
        </div>
        ...
        <div className="location flex flex-col items-center justify-center gap-[10px]">
          <p className="text-[16px] text-[#464646]">Location</p>
          <img src="/images/finLocation.png" alt="" className="h-[40px] w-[40px]" />
          <div className="text-[#464646] text-[16px] font-medium">
            {locationRating}
          </div>
        </div>
        ...
        <div className="food flex flex-col items-center justify-center gap-[10px]">
          <p className="text-[16px] text-[#464646]">Food</p>
          <img src="/images/spatula.png" alt="" className="h-[40px] w-[40px]" />
          <div className="text-[#464646] text-[16px] font-medium">
            {foodRating}
          </div>
        </div>
        ...
        <div className="landlord flex flex-col items-center justify-center gap-[10px]">
          <p className="text-[16px] text-[#464646]">Landlord</p>
          <img src="/images/finUser.png" alt="" className="h-[40px] w-[40px]" />
          <div className="text-[#464646] text-[16px] font-medium">
            {landlordRating}
          </div>
        </div>
